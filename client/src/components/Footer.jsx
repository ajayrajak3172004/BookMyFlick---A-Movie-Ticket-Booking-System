...
export default function Footer() {
    return (
        <div>
            <footer className="px-6 pt-8 md:px-16 lg:px-36   w-full text-gray-300 mt-56">
                <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-10">
                    <div className="md:max-w-96">
                        ...
                        <p className="mt-6 text-sm">
                            Your one-stop platform for booking movie tickets. Browse movies, select seats, and get instant confirmation — fast, easy, and secure.
                        </p>
                ...
                <p className="pt-4 text-center text-sm pb-5">
                    Copyright {new Date().getFullYear()} © <a href="/">BookMyFlick</a>. All Right Reserved.
                </p>
            </footer>
        </div>
    )
